...
public sealed class GoodsReceivedNotesController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateGoodsReceivedNoteRequest request, CancellationToken cancellationToken)
    {
